...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, pretrain_img_size=224, patch_size=4, in_chans=3,
        ...
        for i_layer in range(min(self.out_indices[0] + 1, self.num_layers)):
    ...
    def forward(self, x):
        ...
        outs = {}
        for i in range(min(self.out_indices[0] + 1, self.num_layers)):
            layer = self.layers[i]
            ...
            if i in self.out_indices:
                ...
                outs[f"layer{i}"] = out
        x_c2, x_c3 = outs['layer1'], outs['layer2']
        x_c2 = self.conv(x_c2)
        x_c3 = (x_c3 + x_c2).flatten(2).transpose(1, 2)
        outs = {'0': x_c3}
        return outs
